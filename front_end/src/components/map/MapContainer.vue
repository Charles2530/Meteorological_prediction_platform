...
let map: { addControl: (arg0: any) => void; add: (arg0: any) => void; remove: (arg0: any) => void; setFitView: (arg0: any) => void; on: (arg0: string, arg1: (e: { lnglat: { lng: any; lat: any; }; }) => void) => void; setCenter: (arg0: number[]) => void; setZoom: (arg0: number) => void; } | null = null;
let AAMap: { Polygon: new (arg0: { strokeWeight: number; path: any; fillOpacity: number; fillColor: string; strokeColor: string; }) => any; } = null;
...
function drawBounds() {
  //行政区查询
  dis_info.district.search(dis_info.districtCode, function(_status: any, result: { districtList: { boundaries: any; }[]; }) {
